...
export default function Home() {
  ...
  // Helper: translate + rotate from right to center
  const makeCardTransform = (start: number, end: number) => ({
    x: useTransform(scrollYProgress, [start, end], ["200%", "0%"]),
    rotate: useTransform(scrollYProgress, [start, end], [45, 0]),
    opacity: useTransform(scrollYProgress, [start, end], [0, 1]),
  });

  const card1 = makeCardTransform(0.05, 0.2);
  const card2 = makeCardTransform(0.2, 0.35);
  const card3 = makeCardTransform(0.35, 0.5);
  ...
  const blackOpacity = useTransform(finalProgress, [0, 1], [1, 0]);
  const whiteOpacity = useTransform(finalProgress, [0, 1], [0, 1]);
    ...
    <div className="relative text-[#8D1A1B]">
      ...
      <div className="sticky top-0 bg-[url('/homePageImg1.avif')] z-40 bg-cover bg-center h-screen w-full flex items-center justify-center">
        ...
        >
          ...
          <div
            className={`${montserrat.className} text-sm xs:text-base sm:text-lg md:text-xl lg:text-xl text-gray-900 leading-relaxed font-light space-y-4 px-0 xs:px-4 sm:px-8 md:px-16 lg:px-32`}
          >
            <p>
            ...
            <div className="w-full h-full grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-6 xs:p-8 sm:p-10 md:p-12 flex flex-col justify-center overflow-y-auto">
                ...
                >
                  ...
                  legal pillars supporting this "chip of change. The piece aims
                  to provide strategic legal insights for both domestic and
                  international players eyeing India as a potential hub in the
                  global semicon . . .
                </p>
                <button className="text-xs xs:text-sm font-semibold text-gray-900 hover:text-[#8D1A1B] transition-colors self-start">
      ...
      {/* === FINAL FADE SECTION === */}
      <div ref={finalRef} className="relative h-[200vh] w-full z-60">
        {/* Black Section */}
        <motion.div
        ...
        <motion.div
          style={{ opacity: 1 }}
          className="sticky top-0 h-screen w-full flex items-center justify-center bg-white z-20 -mt-[100vh]"
        >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 xs:gap-8 sm:gap-10 md:gap-12 lg:gap-16">
                ...
                <div className="lg:col-span-2 space-y-4 xs:space-y-5 sm:space-y-6">
                  <p className="text-sm xs:text-base sm:text-lg leading-relaxed text-gray-700">
                    ...
                    It's an opportunity to tell the story behind the business or
